...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <form class="form-inline" method="post" action="/xss-reflected">
                        @csrf
                        <div class="form-group mb-2">
                            <label  class="sr-only">XSS_REFLECTED</label>
                            <input  type="text" readonly class="form-control-plaintext" id="staticEmail2" value="XssReflected">
                        </div>
                ...
                <div class="col-sm">
                    <form class="form-inline" method="post" action="/xss-store">
                        @csrf
                        <div class="form-group mb-2">
                            <label  class="sr-only">XSS_STORE</label>
                            <input  type="text" readonly class="form-control-plaintext" id="staticEmail2" value="XSS_STORE">
                        </div>
                        <div class="form-group mx-sm-3 mb-2">
                            <label for="inputPassword2" class="sr-only">Name</label>
                            <input type="text" name="name" class="form-control" id="inputPassword2" placeholder="Name">
                ...
                <div class="col-sm">
                    <form class="form-inline" method="get" onsubmit="xss()">
                        @csrf
                        <div class="form-group mb-2">
                            <label  class="sr-only">XSS_DOM_BASE</label>
                            <input  type="text" readonly class="form-control-plaintext" id="staticEmail2" value="XSS_DOM_BASE">
                        </div>
                        <div class="form-group mx-sm-3 mb-2">
                            <label for="inputPassword2" class="sr-only">Name</label>
                            <input type="text" name="name" class="form-control" id="dom" placeholder="Name">
                        </div>
                        <button type="submit" class="btn btn-primary mb-2">Submit</button>
                    </form>
                </div>

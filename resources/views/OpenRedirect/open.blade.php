...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <form class="form-inline" method="post" action="/open-redirect">
                        @csrf
                        <div class="form-group mb-2">
                            <label class="sr-only">Open_Redirect</label>
                            <input type="text" readonly class="form-control-plaintext" id="staticEmail2"
                                   value="PressButton to RefreshPage:">
                            <button type="submit" class="btn btn-dark mb-2">Refresh</button>
                        </div>
                        <br>
            ...
            <div class="row">
                <div class="col-sm">
                    <form class="form-inline" method="get" action="/open-redirect/home">
                        @csrf
                        <div class="form-group mb-2">
                            <label class="sr-only">Open_Redirect</label>
                            <input type="text" readonly class="form-control-plaintext" id="staticEmail2"
                                   value="PressButton to Go Home:">
                            <button type="submit" class="btn btn-dark mb-2">Home Page</button>
                        </div>
        ...
        @isset($check)
            @if(!empty($check))
                ...
                <center><span>your name is exist</span></center>

            @else
                <center><span>your name is <b>NOT</b> exist</span></center>
            @endif
        @endisset

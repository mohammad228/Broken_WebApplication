...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <h1>File Upload Challenge 5</h1>
        <div class="main-w3layouts wrapper">
            <form action="file_upload_5" method="post"  onsubmit="return Validate(this)" enctype="multipart/form-data">
                @csrf
            ...
            @isset($success)
                ...
                @if($success===true)
                    ...
                    {!! "Click"!!}&nbsp;<a href="/files/{{$link}}">Here</a>&nbsp;{!!"to check your File" !!}

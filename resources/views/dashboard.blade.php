...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <h1 class="mt-4">Broken-WebApp First Edition</h1>
            <p>This is a vulnerable application to include following vulnerability: </p>
            <p>Cross Side Script (XSS)</p><br>
            <p>Sql Injection On Mysql (Sqli)</p><br>
            <p>Open Redirect </p><br>
            <p>Execute After Redirect (EAR) </p><br>
            <p>Bypass Captcha Logic </p><br>
            <p>Vulnerable File Upload </p><br>
            <p></p><br>
        </div>
    </div>

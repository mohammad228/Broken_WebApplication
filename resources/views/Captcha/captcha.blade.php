...
{{--                    </li>--}}
        ...
        <form name="frmContact" method="post" action="captcha">
            @csrf
        ...
        <form name="frmContact" method="post" action="captcha2">
            @csrf
            <div class="message"><?php if (isset($message)) {
                    echo $message;
                } ?></div>
            <table border="0" cellpadding="10" cellspacing="1" width="500" align="center">
                <tr class="tableheader">
                    <td colspan="2">After 3 time of more captcha will activate</td>

                </tr>
                <tr class="tableheader">

                    <td colspan="6">Enter Contact Information</td>
